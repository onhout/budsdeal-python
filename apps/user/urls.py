...
urlpatterns = [
    ...
    url(r'^feedback/product/(?P<product_id>[\w-]+)', views.product_feedback, name='product_feedback'),
    url(r'^feedback/(?P<display_name>[\w-]+)', views.user_feedback, name='user_feedback'),
]
